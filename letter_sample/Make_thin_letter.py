...
def Make_thin_letter(input,layer_no,scale_x,scale_y,thin):
    ...
    if input == "A":
        ...
        points = [(size_n,(0.1*y-size_n)),(size_n,(1*y-size_n)),((1*x-size_n),(1*y-size_n)),((1*x-size_n),(0.1*y-size_n)),((1*x-size_n),(size_n)),((size_n),size_n)]
        rect1 = gdstk.FlexPath(points,size,joins=["natural"],ends=["extended"])
        points = [((1*x-size_n),size_n),((1*x/2-size_n),(1*y/2-size_n)),((1*x/2-size_n),(1*y/2)),((1*x+size_n),size_n)]
        rect2 = gdstk.FlexPath(points,size,joins=["round"],ends=["round"])
        step1 = gdstk.boolean(rect1,rect2,"or",layer=int(layer_no))
        return step1
    elif input == "R":
        points = [(size_n,size_n),(size_n,(1*y-size_n)),((0.9*x-size_n),(1*y-size_n)),((1*x-size_n),(0.9*y-size_n)),((1*x-size_n),(0.6*y-size_n)),((0.9*x-size_n),1*y/2),
        ...
        points =[((1*x-size_n),(0.9*y-size_n)),((0.9*x-size_n),(1*y-size_n)),(size_n,(1*y-size_n)),(size_n,(1*y/2)),((1*x-size_n),(0.6*y-size_n)),((0.9*x-size_n),(1*y/2))]
        rect1 = gdstk.FlexPath(points,size,joins=["natural"],ends=["extended"])
        points = [(size_n,(1*y/2)),((0.9*x-size_n),(1*y/2)),((1*x-size_n),(0.4*y+size_n)),((1*x-size_n),(0.15*y-size_n)),((0.85*x+size_n),size_n),(size_n,size_n)]
        rect2 = gdstk.FlexPath(points,size,joins=["natural"],ends=["extended"])
        step1 = gdstk.boolean(rect1,rect2,"or",layer=int(layer_no))
        return step1 
    elif input == "T":
