...
def generate(priority,outlayer,inlayer,key_type,boundary):
   ...
   # OVERLAY_In/Out_Layer_TEXT_Define
    ...
    left = gdstk.Cell("TEXT_" + layer_in + "_" + layer_out) # left_outlayer_TEXT_Define
    right = gdstk.Cell("TEXT_" + layer_in)                  # right_inlayer_TEXT_Define
    ...
    bl_p = gdstk.Cell("TEXT_" + layer_in + "_BL")           # BL_TEXT_Define
    br_p = gdstk.Cell("TEXT_" + layer_in + "_BR")      # BR_TEXT_Define
    ul_p = gdstk.Cell("TEXT_" + layer_in + "_UL")       # UL_TEXT_Define
    ur_p = gdstk.Cell("TEXT_" + layer_in + "_UR")      # UR_TEXT_Define
...
def main(priority,outlayer,inlayer,key_type,boundary,lib):  
    bl = gdstk.Cell(key_type +"_BL")      # BR_TEXT_Define
    br = gdstk.Cell(key_type +"_BR")      # BL_TEXT_Define
    ul = gdstk.Cell(key_type +"_UL")      # UL_TEXT_Define
    ur = gdstk.Cell(key_type +"_UR")      # UR_TEXT_Define
...
if __name__ == "__main__":
    ...
    bl, br, ul, ur = main(priority,outlayer,inlayer,key_type,boundary,lib)
