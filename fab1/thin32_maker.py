...
def get_arr():
    #input 파일 정보 가져오기
    with open('./fab1/thin32_input','r') as f:
        lines = f.readlines()
        for line in lines:
            line_st=line.strip()
...
def start():
    ...
    lib1 = gdstk.Library()
    cell1 = lib1.new_cell(PROCESS[0]+"_THIN32_1_1_50_"+time.strftime("%Y%m%d"))
    lib2 = gdstk.Library()
    cell2 = lib2.new_cell(PROCESS[0]+"_THIN32_1_2_50_"+time.strftime("%Y%m%d"))
    lib3 = gdstk.Library()
    cell3 = lib3.new_cell(PROCESS[0]+"_THIN32_1_3_50_"+time.strftime("%Y%m%d"))
    lib4 = gdstk.Library()
    cell4 = lib4.new_cell(PROCESS[0]+"_THIN32_2_1_50_"+time.strftime("%Y%m%d"))
    lib5 = gdstk.Library()
    cell5 = lib5.new_cell(PROCESS[0]+"_THIN32_2_2_50_"+time.strftime("%Y%m%d"))
    lib6 = gdstk.Library()
    cell6 = lib6.new_cell(PROCESS[0]+"_THIN32_2_3_50_"+time.strftime("%Y%m%d"))
    lib7 = gdstk.Library()
    cell7 = lib7.new_cell(PROCESS[0]+"_THIN32_2_4_50_"+time.strftime("%Y%m%d"))
    lib8 = gdstk.Library()
    cell8 = lib8.new_cell(PROCESS[0]+"_THIN32_2_5_50_"+time.strftime("%Y%m%d"))
    lib9 = gdstk.Library()
    cell9 = lib9.new_cell(PROCESS[0]+"_THIN32_2_6_50_"+time.strftime("%Y%m%d"))
    ...
    if cell1.references != [] :
        lib1.write_gds("./fab1/f1_gdsout/pre_thin32_1.gds")
    if cell2.references != [] :
        lib2.write_gds("./fab1/f1_gdsout/pre_thin32_2.gds")
    if cell3.references != [] :
        lib3.write_gds("./fab1/f1_gdsout/pre_thin32_3.gds")
    if cell4.references != [] :
        lib4.write_gds("./fab1/f1_gdsout/pre_thin32_4.gds")
    if cell5.references != [] :
        lib5.write_gds("./fab1/f1_gdsout/pre_thin32_5.gds")
    if cell6.references != [] :
        lib6.write_gds("./fab1/f1_gdsout/pre_thin32_6.gds")
    if cell7.references != [] :
        lib7.write_gds("./fab1/f1_gdsout/pre_thin32_7.gds")
    if cell8.references != [] :
        lib8.write_gds("./fab1/f1_gdsout/pre_thin32_8.gds")
    if cell9.references != [] :
        lib9.write_gds("./fab1/f1_gdsout/pre_thin32_9.gds")
