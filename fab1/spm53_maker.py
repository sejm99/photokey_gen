...
def get_arr():
    #input 파일 정보 가져오기
    with open('./fab1/spm53_input','r') as f:
        lines = f.readlines()
        for line in lines:
            line_st=line.strip()
...
def generate(priority,layer_no,gds_name,boundary,etch_type,main_x,main_y,bar_x,bar_y,process):
    ...
    for i in range(0,40):
        if float(bar_x)==1.6:
            ...
            spm_1 = gdstk.rectangle((x1, 2.5),(x1+float(bar_x),2.5+float(bar_y)), layer=int(layer_no))
            pre_result.add(spm_1)
            x2 = float(x1+float(bar_x)+1.6)
            spm_1 = gdstk.rectangle((x2, 2.5),(x2+float(bar_x),2.5+float(bar_y)), layer=int(layer_no))
            pre_result.add(spm_1)
            x3 = float(x2+float(bar_x)+1.6)
            spm_1 = gdstk.rectangle((x3, 2.5),(x3+float(bar_x),2.5+float(bar_y)), layer=int(layer_no))
            pre_result.add(spm_1)    
        else:
            if i < 21:
                x1 = 15+35.7+((13.8+float(bar_x))*i)
            else:
                x1 = 15+437.5+((15.4+float(bar_x))*(i-21))
            spm_1 = gdstk.rectangle((x1, 2.5),(x1+float(bar_x),2.5+float(bar_y)), layer=int(layer_no))
            pre_result.add(spm_1)
            x2 = float(x1+float(bar_x)+1)
            spm_1 = gdstk.rectangle((x2, 2.5),(x2+float(bar_x),2.5+float(bar_y)), layer=int(layer_no))
            pre_result.add(spm_1)
            x3 = float(x2+float(bar_x)+1)
            spm_1 = gdstk.rectangle((x3, 2.5),(x3+float(bar_x),2.5+float(bar_y)), layer=int(layer_no))
            pre_result.add(spm_1)
        spm_cross1 = gdstk.rectangle((15+399.5, 22.5),(15+400.5, 27.5), layer=int(layer_no))
        spm_cross2 = gdstk.rectangle((15+397.5, 24.5),(15+402.5, 25.5), layer=int(layer_no))
        pre_result.add(spm_cross1)
        pre_result.add(spm_cross2)
    if etch_type == "M":
        rect = gdstk.rectangle((15,0),(int(main_x)+15,int(main_y)))
        spm_2 = gdstk.boolean(rect,gdstk.Reference(pre_result),"not",layer=int(layer_no))
        result.add(*spm_2)
    else:
        rect = gdstk.rectangle((15, 0),(int(main_x)+15,int(main_y)))
        spm_2 = gdstk.boolean(rect,gdstk.Reference(pre_result),"and",layer=int(layer_no))
        result.add(*spm_2)
    return result
...
def start():
    ...
    if PROCESS[0] == "181ABD18BA" or PROCESS[0] == "1830AN18BA":
        lib1 = gdstk.Library()
        cell1 = lib1.new_cell(PROCESS[0]+"_preSPM53_1_1_50_"+time.strftime("%Y%m%d"))
        lib2 = gdstk.Library()
        cell2 = lib2.new_cell(PROCESS[0]+"_preSPM53_1_2_50_"+time.strftime("%Y%m%d"))
        lib3 = gdstk.Library()
        cell3 = lib3.new_cell(PROCESS[0]+"_preSPM53_1_3_50_"+time.strftime("%Y%m%d"))
        lib4 = gdstk.Library()
        cell4 = lib4.new_cell(PROCESS[0]+"_preSPM53_2_1_50_"+time.strftime("%Y%m%d"))
        lib5 = gdstk.Library()
        cell5 = lib5.new_cell(PROCESS[0]+"_preSPM53_2_2_50_"+time.strftime("%Y%m%d"))
        lib6 = gdstk.Library()
        cell6 = lib6.new_cell(PROCESS[0]+"_preSPM53_2_3_50_"+time.strftime("%Y%m%d"))
        lib7 = gdstk.Library()
        cell7 = lib7.new_cell(PROCESS[0]+"_preSPM53_2_4_50_"+time.strftime("%Y%m%d"))
        lib8 = gdstk.Library()
        cell8 = lib8.new_cell(PROCESS[0]+"_preSPM53_2_5_50_"+time.strftime("%Y%m%d"))
        lib9 = gdstk.Library()
        cell9 = lib9.new_cell(PROCESS[0]+"_preSPM53_2_6_50_"+time.strftime("%Y%m%d"))
    else:
        lib1 = gdstk.Library()
        cell1 = lib1.new_cell(PROCESS[0]+"_SPM53_1_1_50_"+time.strftime("%Y%m%d"))
        lib2 = gdstk.Library()
        cell2 = lib2.new_cell(PROCESS[0]+"_SPM53_1_2_50_"+time.strftime("%Y%m%d"))
        lib3 = gdstk.Library()
        cell3 = lib3.new_cell(PROCESS[0]+"_SPM53_1_3_50_"+time.strftime("%Y%m%d"))
        lib4 = gdstk.Library()
        cell4 = lib4.new_cell(PROCESS[0]+"_SPM53_2_1_50_"+time.strftime("%Y%m%d"))
        lib5 = gdstk.Library()
        cell5 = lib5.new_cell(PROCESS[0]+"_SPM53_2_2_50_"+time.strftime("%Y%m%d"))
        lib6 = gdstk.Library()
        cell6 = lib6.new_cell(PROCESS[0]+"_SPM53_2_3_50_"+time.strftime("%Y%m%d"))
        lib7 = gdstk.Library()
        cell7 = lib7.new_cell(PROCESS[0]+"_SPM53_2_4_50_"+time.strftime("%Y%m%d"))
        lib8 = gdstk.Library()
        cell8 = lib8.new_cell(PROCESS[0]+"_SPM53_2_5_50_"+time.strftime("%Y%m%d"))
        lib9 = gdstk.Library()
        cell9 = lib9.new_cell(PROCESS[0]+"_SPM53_2_6_50_"+time.strftime("%Y%m%d"))
    lib1_s = gdstk.Library()
    cell1_s = lib1_s.new_cell(PROCESS[0]+"_SPM53_S_1_1_50_"+time.strftime("%Y%m%d"))
    lib2_s = gdstk.Library()
    cell2_s = lib2_s.new_cell(PROCESS[0]+"_SPM53_S_1_2_50_"+time.strftime("%Y%m%d"))
    lib3_s = gdstk.Library()
    cell3_s = lib3_s.new_cell(PROCESS[0]+"_SPM53_S_1_3_50_"+time.strftime("%Y%m%d"))
    lib4_s = gdstk.Library()
    cell4_s = lib4_s.new_cell(PROCESS[0]+"_SPM53_S_2_1_50_"+time.strftime("%Y%m%d"))
    lib5_s = gdstk.Library()
    cell5_s = lib5_s.new_cell(PROCESS[0]+"_SPM53_S_2_2_50_"+time.strftime("%Y%m%d"))
    lib6_s = gdstk.Library()
    cell6_s = lib6_s.new_cell(PROCESS[0]+"_SPM53_S_2_3_50_"+time.strftime("%Y%m%d"))
    lib7_s = gdstk.Library()
    cell7_s = lib7_s.new_cell(PROCESS[0]+"_SPM53_S_2_4_50_"+time.strftime("%Y%m%d"))
    lib8_s = gdstk.Library()
    cell8_s = lib8_s.new_cell(PROCESS[0]+"_SPM53_S_2_5_50_"+time.strftime("%Y%m%d"))
    lib9_s = gdstk.Library()
    cell9_s = lib9_s.new_cell(PROCESS[0]+"_SPM53_S_2_6_50_"+time.strftime("%Y%m%d"))
    ...
    for i in range(0,len(PRORITY)):
        ...
        if PRORITY[i] == "1":
            if BAR_X[i] == "2.2":
                lib1_s.add(res)
                cell1_s.add(gdstk.Reference(res,(0,0)))
                lib1_s.add(res1)
                cell1_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib1.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib2_s.add(res)
                cell2_s.add(gdstk.Reference(res,(0,0)))
                lib2_s.add(res1)
                cell2_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib2.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib3_s.add(res)
                cell3_s.add(gdstk.Reference(res,(0,0)))
                lib3_s.add(res1)
                cell3_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib3.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib4_s.add(res)
                cell4_s.add(gdstk.Reference(res,(0,0)))
                lib4_s.add(res1)
                cell4_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib4.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib5_s.add(res)
                cell5_s.add(gdstk.Reference(res,(0,0)))
                lib5_s.add(res1)
                cell5_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib5.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib6_s.add(res)
                cell6_s.add(gdstk.Reference(res,(0,0)))
                lib6_s.add(res1)
                cell6_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib6.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib7_s.add(res)
                cell7_s.add(gdstk.Reference(res,(0,0)))
                lib7_s.add(res1)
                cell7_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib7.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib8_s.add(res)
                cell8_s.add(gdstk.Reference(res,(0,0)))
                lib8_s.add(res1)
                cell8_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib8.add(res)
            ...
            if BAR_X[i] == "2.2":
                lib9_s.add(res)
                cell9_s.add(gdstk.Reference(res,(0,0)))
                lib9_s.add(res1)
                cell9_s.add(gdstk.Reference(res1,(0,float(MAIN_Y[i])),rotation=np.pi*1.5))
            else:
                lib9.add(res)
    ...
    if cell1.references != [] :
        lib1.write_gds("./fab1/f1_gdsout/pre_spm53_1.gds")
    if cell2.references != [] :
        lib2.write_gds("./fab1/f1_gdsout/pre_spm53_2.gds")
    if cell3.references != [] :
        lib3.write_gds("./fab1/f1_gdsout/pre_spm53_3.gds")
    if cell4.references != [] :
        lib4.write_gds("./fab1/f1_gdsout/pre_spm53_4.gds")
    if cell5.references != [] :
        lib5.write_gds("./fab1/f1_gdsout/pre_spm53_5.gds")
    if cell6.references != [] :
        lib6.write_gds("./fab1/f1_gdsout/pre_spm53_6.gds")
    if cell7.references != [] :
        lib7.write_gds("./fab1/f1_gdsout/pre_spm53_7.gds")
    if cell8.references != [] :
        lib8.write_gds("./fab1/f1_gdsout/pre_spm53_8.gds")
    if cell9.references != [] :
        lib9.write_gds("./fab1/f1_gdsout/pre_spm53_9.gds")
    if cell1_s.references != [] :
        lib1_s.write_gds("./fab1/f1_gdsout/pre_spm53_1_size.gds")
    if cell2_s.references != [] :
        lib2_s.write_gds("./fab1/f1_gdsout/pre_spm53_2_size.gds")
    if cell3_s.references != [] :
        lib3_s.write_gds("./fab1/f1_gdsout/pre_spm53_3_size.gds")
    if cell4_s.references != [] :
        lib4_s.write_gds("./fab1/f1_gdsout/pre_spm53_4_size.gds")
    if cell5_s.references != [] :
        lib5_s.write_gds("./fab1/f1_gdsout/pre_spm53_5_size.gds")
    if cell6_s.references != [] :
        lib6_s.write_gds("./fab1/f1_gdsout/pre_spm53_6_size.gds")
    if cell7_s.references != [] :
        lib7_s.write_gds("./fab1/f1_gdsout/pre_spm53_7_size.gds")
    if cell8_s.references != [] :
        lib8_s.write_gds("./fab1/f1_gdsout/pre_spm53_8_size.gds")
    if cell9_s.references != [] :
        lib9_s.write_gds("./fab1/f1_gdsout/pre_spm53_9_size.gds")
