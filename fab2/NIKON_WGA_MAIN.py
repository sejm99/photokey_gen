...
from fab2 import NIKON_WGA,NIKON_WGA_54
import pandas as pd
...
def main(process,priority,layer_no,key_type,boundary,file_n):
    ...
    top_cell = process +'_'+fn+'_'+str(date)
    ...
    for i in range(0,len(df_sort)) :
        ...
        if process.find("LD11") != 0:
            res = NIKON_WGA.generate(int(PRIORITY),int(LAYER_NO),KEY_TYPE,BOUNDARY)
            lib.add(res)
        else:
            res = NIKON_WGA_54.generate(int(PRIORITY),int(LAYER_NO),KEY_TYPE,BOUNDARY)
            lib.add(res)
        ...
        elif main_x == 50 or main_x == 75 or main_x == 54:
    ...
    output_name = "./fab2/f2_gdsout/"+key_names+"/"+top_cell+".gds"
    lib.write_gds(output_name)

    pro = process.split('_')
    out = "./fab2/f2_gdsout/"+key_names+"/"+key_names+"/"+top_cell+'.'+fn+'_x'
    ...
    out2 = "./fab2/f2_gdsout/"+key_names+"/"+key_names+"/"+top_cell+'.'+fn+'_y'
...
if __name__ == '__main__':
    ...
    key_type = ["WGA_200_50_3_0_4_0_T","WGA_200_50_4_0_2_0_T","WGA_50_50_2_8_2_8_T","WGA_200_50_4_0_2_0_T","WGA_200_50_3_0_4_0_T"]
