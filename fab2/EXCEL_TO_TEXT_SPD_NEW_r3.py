## History ##
# Change the BASEPAD define - 2026/02/24
import pandas as pd

def photokey_files(excel_file,process):
    with pd.ExcelFile('./upload/'+excel_file) as input_file:
